...
class Enigma:
    ...
    def rotors_r(self, letter_in):
        for rotor in range(0, 3):
            ...
            # letter_out = rotor_nums[self.rotors[rotor]].find(
            # (letter_in + self.rotor_pos[rotor]) % 26)
...
def main():
    ...
    # p(enigma.etw_l(0), "etw")
    # p(enigma.rotors_l(0), "rot")
    # p(enigma.ukw(6), "ukw")
    # p(enigma.rotors_r(11), "rot")
    # p(enigma.etw_r(13), "etw")
    # p(enigma.plugboard(4), "plug - OUTPUT")
    from randomtest import ip
