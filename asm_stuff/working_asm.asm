...
pin_modes:                                                  ; address: 0x0004
        ...
        bcf     TMR1H, 0x0                                  ; reg: 0x00f - set MSbyte of timer1 to x110xxx0
        bcf     STATUS, RP0                                 ; reg: 0x003, bit: 5 - bank 0 
        btfsc   PORTA, RA3                                  ; reg: 0x005, bit: 3 - bit test f skip if clear RA3 on port A - check if 
        goto    label_003                                   ; if previous bit check set (test_sw not ON) do this func
        goto    test_switch_init                                   ; if test switch on do this

label_003:                                                  ; address: 0x0028

        call    disp_encode
        bsf     STATUS, RP0                                 ; reg: 0x003, bit: 5 - bank 1 
        bcf     TMR0, 0x5                                   ; reg: 0x001 - clear bit 5 of option reg - timer0 setup
        bcf     STATUS, RP0                                 ; reg: 0x003, bit: 5 - bank 0
        movlw   0x01
        movwf   0x45                                        ; reg: 0x045 put 0x01 in 0x045
        movlw   0x49    
        movwf   FSR                                         ; reg: 0x004 - put 0x49 in FSR

label_004:                                                  ; address: 0x0030

        call    function_009
        btfsc   0x43, 0x2                                   ; reg: 0x043 bt 0x43 bit 2 skip if clear
        goto    label_010                                   ; do this if bit is set - ie cam1 was pressed 
        call    function_006
...
label_010:                                                  ; address: 0x005c
        ...
        call    disp_decode
        decf    0x45, F                                     ; reg: 0x045 - 0x45 -= 1
        movlw   0x4a                                        ; move 0x4a to W
        movwf   FSR                                         ; reg: 0x004 - 0x4a in FSR
...
test_switch_init:                                                  ; address: 0x007c
...
label_068:                                                  ; address: 0x01a5
        ...
        call    clear_BC
        call    clear_regs_20_3a
        goto    label_015

clear_regs_20_3a:                                               ; address: 0x01a8
...
delay_160000_cyc:                                               ; address: 0x020c

        movlw   0x64
        movwf   0x3f                                        ; reg: 0x03f -> load 100 into 3f

label_072:                                                  ; address: 0x020e

        movlw   0x28
        movwf   0x3e                                        ; reg: 0x03e -> 40

label_073:                                                  ; address: 0x0210

        movlw   0x28
        movwf   0x3d                                        ; reg: 0x03d -> 40

label_074:                                                  ; address: 0x0212

        decfsz  0x3d, F                                     ; reg: 0x03d -> dec 0x3d skip if zero
        goto    label_074
        decfsz  0x3e, F                                     ; reg: 0x03e -> dec 0x3e skip if zero
        goto    label_073
        decfsz  0x3f, F                                     ; reg: 0x03f -> dec 0x3f skip if zero -> 160000 cycles total
        goto    label_072
        return
...
delay_72000_cyc:                                               ; address: 0x0226

        movlw   0x2d
        movwf   0x3f                                        ; reg: 0x03f - puts 45 in 0x3f (gpr)

label_078:                                                  ; address: 0x0228

        movlw   0x28                                        ; puts 40 in e
        movwf   0x3e                                        ; reg: 0x03e

label_079:                                                  ; address: 0x022a

        movlw   0x28                                        ; puts 40 in d
        movwf   0x3d                                        ; reg: 0x03d
...
function_006:                                               ; address: 0x0248
        ...
        bcf     0x43, 0x0                                   ; reg: 0x043 clear first bit of 0x43
        bcf     PORTD, RD0                                  ; reg: 0x008, bit: 0 - row 1 low
        bsf     PORTD, RD1                                  ; reg: 0x008, bit: 1 - row 2 high
        bsf     PORTD, RD2                                  ; reg: 0x008, bit: 2 - row 3 high
        btfsc   PORTB, RB0                                  ; reg: 0x006, bit: 0 - bit test col 1 - skip if clear (r1,c1 pressed)
        goto    label_083                                   ; if not pressed
        incfsz  0x20, W                                     ; reg: 0x020 increase 0x20
        movwf   0x20                                        ; reg: 0x020
        btfss   0x20, 0x7                                   ; reg: 0x020 check if bit 7 set
        goto    label_083                                   ; if not negative
        btfss   0x20, 0x6                                   ; reg: 0x020 check if bit 6 set
        goto    label_083                                   ; if not set
        movlw   0x01
        movwf   0x3c                                        ; reg: 0x03c put 1 in this
        goto    label_108                           

label_083:                                                  ; address: 0x0257

        btfsc   PORTB, RB1                                  ; reg: 0x006, bit: 1  bit test col 2 - skip if clear (low row ,c2 pressed)
        goto    label_084                                   ; if not pressed
        incfsz  0x21, W                                     ; reg: 0x021
        movwf   0x21                                        ; reg: 0x021
        btfss   0x21, 0x7                                   ; reg: 0x021
        goto    label_084
...
label_084:                                                  ; address: 0x0262
        ...
        btfsc   PORTB, RB2                                  ; reg: 0x006, bit: 2 check col 3
        goto    label_085                                   ; not pressed
        incfsz  0x22, W                                     ; reg: 0x022
        movwf   0x22                                        ; reg: 0x022
        btfss   0x22, 0x7                                   ; reg: 0x022
        goto    label_085                                   
...
label_108:                                                  ; address: 0x0372
        ...
        call    clear_regs_20_3a
        bsf     0x43, 0x0                                   ; reg: 0x043 set bit 0 
...
function_009:                                               ; address: 0x048d
        ...
        bcf     0x43, 0x2                                   ; reg: 0x043 - clear bit 2
        btfsc   PORTA, RA4                                  ; reg: 0x005, bit: 4 - bit test cam1 switch skip if clear (LH rotor)
        goto    label_137                                   ; ret if bit not clear (sw not pressed) 
        incfsz  0x44, W                                     ; reg: 0x044 inc 0x44 skip if zero store in W
        movwf   0x44                                        ; reg: 0x044 mov W to 0x44
        btfss   0x44, 0x7                                   ; reg: 0x044 bit test 0x44 bit 7 skip if set
        goto    label_137                                   ; return if not set - ie number is positive
        bsf     0x43, 0x2                                   ; reg: 0x043 set bit 2 of 0x43 if num is neg
...
disp_encode:                                               ; address: 0x049d

        bsf     PORTC, RC0                                  ; reg: 0x007, bit: 0 - col 3
        bsf     PORTD, RD5                                  ; reg: 0x008, bit: 5 - row 1 -> E on
        call    delay_160000_cyc
        bcf     PORTC, RC0                                  ; reg: 0x007, bit: 0 -> E off
        bcf     PORTD, RD5                                  ; reg: 0x008, bit: 5
        call    delay_160000_cyc
        return

disp_decode:                                               ; address: 0x04a4

        bsf     PORTC, RC0                                  ; reg: 0x007, bit: 0 - turn on col 3
        bsf     PORTD, RD6                                  ; reg: 0x008, bit: 6 - turn on row 2 - D
        call    delay_160000_cyc
        bcf     PORTC, RC0                                  ; reg: 0x007, bit: 0 - turn off col 3
        bcf     PORTD, RD6                                  ; reg: 0x008, bit: 6 - turn off row 2
        call    delay_160000_cyc
        return
...
called_by_test:                                               ; address: 0x04b1

        bsf     PORTC, RC2                                  ; reg: 0x007, bit: 2 - c1 high
        bsf     PORTD, RD5                                  ; reg: 0x008, bit: 5 - r1 high
        call    delay_72000_cyc
        call    clear_BC
        bsf     PORTC, RC1                                  ; reg: 0x007, bit: 1 - c2
        bsf     PORTD, RD5                                  ; reg: 0x008, bit: 5 - r1
        call    delay_72000_cyc
        call    clear_BC
        bsf     PORTC, RC0                                  ; reg: 0x007, bit: 0 
        bsf     PORTD, RD5                                  ; reg: 0x008, bit: 5
        ...
        call    clear_BC
        bsf     PORTC, RC2                                  ; reg: 0x007, bit: 2
        bsf     PORTD, RD6                                  ; reg: 0x008, bit: 6 - r2,c1
        call    delay_72000_cyc
        call    clear_BC
        bsf     PORTC, RC1                                  ; reg: 0x007, bit: 1
        bsf     PORTD, RD6                                  ; reg: 0x008, bit: 6 - r2,c2
        call    delay_72000_cyc
        call    clear_BC
        bsf     PORTC, RC0                                  ; reg: 0x007, bit: 0
        bsf     PORTD, RD6                                  ; reg: 0x008, bit: 6
